          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 my-5 space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-700 font-medium">Pack +1000 Sesiones de Baloncesto (Digital)</span>
                <span className="text-xs text-slate-400 line-through">{convertAndFormat(366)}</span>
              </div>
              <div className="flex justify-between items-center text-emerald-600">
                <span className="text-xs font-semibold">Bono #1 al #5 (Manuales, Videoteca y Plantillas)</span>
          ...
          <div className="p-6 md:p-8 text-center flex flex-col items-center">
            ...
            <div className="w-full bg-slate-50 border border-slate-200 rounded-xl p-4 my-6 text-left space-y-4">
              <p className="text-[11px] font-bold text-slate-500 uppercase tracking-wider border-b border-slate-200 pb-2 flex items-center justify-between">
                ...
                <span className="text-emerald-600 font-mono">6 ARCHIVOS DIGITALES</span>
              </p>
              ...
              <div className="flex items-center justify-between gap-2 bg-white p-2.5 rounded-lg border border-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Manual Principal: +1000 Sesiones de Baloncesto</p>
                    <p className="text-[10px] text-slate-400">Formato PDF • 42.1 MB</p>
                  </div>
                </div>
                <a
                  href="#"
              ...
              <div className="flex items-center justify-between gap-2 bg-white p-2.5 rounded-lg border border-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Bono 1: 250 Ejercicios de Dribbling</p>
                    <p className="text-[10px] text-slate-400">Formato PDF • 18.4 MB</p>
                  </div>
                </div>
                <a
                  href="#"
              ...
              <div className="flex items-center justify-between gap-2 bg-white p-2.5 rounded-lg border border-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Bono 2: 180 Ejercicios de Tiro</p>
              ...
              <div className="flex items-center justify-between gap-2 bg-white p-2.5 rounded-lg border border-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Bono 3: Manual de Sistemas Ofensivos</p>
                    <p className="text-[10px] text-slate-400">Formato PDF • 24.1 MB</p>
                  </div>
                </div>
                <a
                  href="#"
              ...
              <div className="flex items-center justify-between gap-2 bg-white p-2.5 rounded-lg border border-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Bono 4: Videoteca de Baloncesto Pro</p>
                    <p className="text-[10px] text-slate-400">Streaming HD • Acceso Online</p>
                  </div>
                </div>
                <a
                  href="#"
              ...
              <div className="flex items-center justify-between gap-2 bg-white p-2.5 rounded-lg border border-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Bono 5: 100 Plantillas para Entrenadores</p>
                    <p className="text-[10px] text-slate-400">Formato PDF • 9.5 MB</p>
                  </div>
                </div>
                <a
                  href="#"
